...
{
    [Authorize]
    public class BusquedaArticulosEntregaSingleLotesApiController : ApiBaseController
    {
        public BusquedaArticulosEntregaSingleLotesApiController(IContextService context) : base(context)
        {
        }
        ...
        public HttpResponseMessage Get()
        {
            ...
            var list = service.GetArticulosLotesAgrupados(almacen, ContextService.Empresa, articulosdesde);
