...
{
    public class ClientesController : GenericController<ClientesModel>
    {
        ...
        {
            MenuName = "Clientes";
            var permisos = appService.GetPermisosMenu("clientes");
        ...
        public ClientesController(IContextService context) : base(context)
        {
        ...
        public override ActionResult CreateOperacion(ClientesModel model)
        {
            try
            {
