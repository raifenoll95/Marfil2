app.controller('AsistenteRegularizacionAperturaProvisionalCrtl', ['$scope', '$rootScope', '$http', '$interval', 'uiGridConstants', '$timeout', function ($scope, $rootScope, $http, $interval, $uiGridConstants, $timeout) {
   ...
   $scope.aceptar = function () {
        ...
        if ($scope.params) {
           ...
           .success(function (response) {
               ...
               if ($scope.gridOptions.data == []) {
                   ...
                   $("#registrosseleccionadoserror").html("NO HAY NINGUNA CUENTA");
                   e.preventDefault();
               }
    ...
    $scope.generarasiento = function () {
        ...
        var comentarioaperturaprovisional = $("[name='ComentarioAperturaProvisional']").val();
        var cuentaaperturaprovisional = $("[name='CuentaReapertura']").val();
        ...
        $("#generarasiento input[name='comentarioaperturaprovisional']").val(comentarioaperturaprovisional);
        $("#generarasiento input[name='cuentaaperturaprovisional']").val(cuentaaperturaprovisional);
