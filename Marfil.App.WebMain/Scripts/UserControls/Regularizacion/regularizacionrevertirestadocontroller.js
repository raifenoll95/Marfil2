app.controller('AsistenteRegularizacionRevertirEstadoCrtl', ['$scope', '$rootScope', '$http', '$interval', 'uiGridConstants', '$timeout', function ($scope, $rootScope, $http, $interval, $uiGridConstants, $timeout) {
    ...
    eventAggregator.RegisterEvent("_generarasientocontable", function () {
   ...
   $scope.aceptar = function () {
    ...
    $scope.generarasiento = function () {
        ...
        var estado = $("#EstadoEjercicioRevertir").val();

        $("#generarasiento input[name='estado']").val(estado);
