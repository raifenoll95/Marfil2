...
{
    public class ComparativaPerdidasYGananciasAnalitica : ListadosModel
    {
        #region Properties
        public override string TituloListado => "Comparativa Pérdidas y Ganancias Analítica";

        public override string IdListado => FListadosModel.ComparativaPYGAnalitica;
        ...
        public ComparativaPerdidasYGananciasAnalitica()
        {

        }

        public ComparativaPerdidasYGananciasAnalitica(IContextService context) : base(context)
        {
        ...
        internal override string GenerarSelect()
        {
            ...
            if (Desglosarniveltres)
            {
                sb.Append("SELECT cab.orden as Orden, cab.descrip as [Descripción], lin.cuenta as Cuenta, lin.saldo as Saldo, lin.saldoea as SaldoEA FROM ReportAnaliticaGuiasBalances cab, ReportAnaliticaGuiasBalancesLineas lin");
            }
            else
            {
                sb.Append("Select orden as Orden, textogrupo as [Texto Grupo], descrip as [Descripción], saldo as Saldo, saldoea as SaldoEA from ReportAnaliticaGuiasBalances");
            }
