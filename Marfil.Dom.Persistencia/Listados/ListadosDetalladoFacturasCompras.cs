...
{
    public class ListadosDetalladoFacturasCompras : ListadosModel
    {
        private List<string> _series = new List<string>();

        #region Properties

        public override string TituloListado => "Listado detallado de Facturas Compras";

        public override string IdListado => FListadosModel.FacturasComprasDetallado;

        public string Order { get; set; }

        [Display(ResourceType = typeof (RFacturasCompras), Name = "SeriesListado")]
        ...
        [Display(ResourceType = typeof(RFacturasCompras), Name = "FechaDesde")]
        public DateTime? FechaDesde { get; set; }

        [Display(ResourceType = typeof(RFacturasCompras), Name = "FechaHasta")]
        public DateTime? FechaHasta { get; set; }

        [Display(ResourceType = typeof(RFacturasCompras), Name = "ProveedorDesde")]
        public string CuentaDesde { get; set; }

        [Display(ResourceType = typeof(RFacturasCompras), Name = "ProveedorHasta")]
        ...
        [Display(ResourceType = typeof(RFacturasCompras), Name = "FkarticulosDesde")]
        public string FkarticulosDesde { get; set; }

        [Display(ResourceType = typeof(RFacturasCompras), Name = "FkarticulosHasta")]
        public string FkarticulosHasta { get; set; }

        [Display(ResourceType = typeof(RFacturasCompras), Name = "FamiliaMateriales")]
        public string Fkfamiliasmateriales{ get; set; }

        [Display(ResourceType = typeof(RFacturasCompras), Name = "FamiliaDesde")]
        public string FkfamiliasDesde { get; set; }

        [Display(ResourceType = typeof(RFacturasCompras), Name = "FamiliaHasta")]
        public string FkfamiliasHasta { get; set; }

        [Display(ResourceType = typeof(RFacturasCompras), Name = "MaterialesDesde")]
        public string FkmaterialesDesde { get; set; }

        [Display(ResourceType = typeof(RFacturasCompras), Name = "MaterialesHasta")]
        public string FkmaterialesHasta { get; set; }

        [Display(ResourceType = typeof(RFacturasCompras), Name = "CaracteristicasDesde")]
        public string FkcaracteristicasDesde { get; set; }

        [Display(ResourceType = typeof(RFacturasCompras), Name = "CaracteristicasHasta")]
        public string FkcaracteristicasHasta { get; set; }

        [Display(ResourceType = typeof(RFacturasCompras), Name = "GrosoresDesde")]
        public string FkgrosoresDesde { get; set; }

        [Display(ResourceType = typeof(RFacturasCompras), Name = "GrosoresHasta")]
        public string FkgrosoresHasta { get; set; }

        [Display(ResourceType = typeof(RFacturasCompras), Name = "AcabadosDesde")]
        public string FkacabadosDesde { get; set; }

        [Display(ResourceType = typeof(RFacturasCompras), Name = "AcabadosHasta")]
        ...
        public List<EstadosModel> Estados
        {
            get
            {
                ...
                {
                    var list = estadoService.GetStates(DocumentoEstado.FacturasCompras).ToList();
        ...
        public ListadosDetalladoFacturasCompras()
        {

        }

        public ListadosDetalladoFacturasCompras(IContextService context) : base(context)
        {
        ...
        internal override string GenerarFiltrosColumnas()
        {
            ...
            if (Series?.Any() ?? false)
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturasCompras.SeriesListado, string.Join(", ", Series.ToArray())));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(Estado) && !Estado.Equals("0-"))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturasCompras.Estado, Estados?.First(f => f.CampoId == Estado).Descripcion??string.Empty));
                flag = true;
            }
            ...
            if (FechaDesde.HasValue)
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturasCompras.FechaDesde, FechaDesde));
                flag = true;
            }
            ...
            if (FechaHasta.HasValue)
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturasCompras.FechaHasta, FechaHasta));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkarticulosDesde))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturasCompras.FkarticulosDesde, FkarticulosDesde));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkarticulosHasta))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturasCompras.FkarticulosHasta, FkarticulosHasta));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(Fkfamiliasmateriales))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturasCompras.FamiliaMateriales, AppService.GetListFamiliaMateriales().SingleOrDefault(f => f.Valor == Fkfamiliasmateriales).Descripcion));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkfamiliasDesde))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturasCompras.FamiliaDesde, FkfamiliasDesde));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkfamiliasHasta))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturasCompras.FamiliaHasta, FkfamiliasHasta));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkmaterialesDesde))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturasCompras.MaterialesDesde, FkmaterialesDesde));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkmaterialesHasta))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturasCompras.MaterialesHasta, FkmaterialesHasta));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkcaracteristicasDesde))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturasCompras.CaracteristicasDesde, FkcaracteristicasDesde));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkcaracteristicasHasta))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturasCompras.CaracteristicasHasta, FkcaracteristicasHasta));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkgrosoresDesde))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturasCompras.GrosoresDesde, FkgrosoresDesde));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkgrosoresHasta))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturasCompras.GrosoresHasta, FkgrosoresHasta));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkacabadosDesde))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturasCompras.AcabadosDesde, FkacabadosDesde));
                flag = true;
            }
            ...
            if (!string.IsNullOrEmpty(FkacabadosHasta))
            {
                ...
                Condiciones.Add(string.Format("{0}: {1}", RFacturasCompras.AcabadosHasta, FkacabadosHasta));
                flag = true;
            }
        ...
        internal override string GenerarSelect()
        {
            var sb = new StringBuilder();
                ...
                " inner join cuentas as cu on (c.empresa= cu.empresa and c.fkcuentas=cu.id) or (ar.empresa= cu.empresa and ar.fkcuentas=cu.id) " +
                " left join direcciones as di on (di.empresa=c.empresa and di.fkentidad=c.fkcuentas) or (di.empresa=ar.empresa and di.fkentidad=ar.fkcuentas) and di.defecto='true' " +
        ...
        public IEnumerable<SeriesModel> SeriesListado
        {
            get
            {
                ...
                return service.GetSeriesTipoDocumento(TipoDocumento.FacturasCompras);
            }
        }
    }
}
