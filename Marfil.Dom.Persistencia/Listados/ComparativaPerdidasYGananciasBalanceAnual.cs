...
{
    public class ComparativaPerdidasYGananciasBalanceAnual : ListadosModel
    {
        #region Properties
        public override string TituloListado => "Balance de cuentas anuales comparativo";

        public override string IdListado => FListadosModel.ComparativaPYGBalanceAnual;
        ...
        public ComparativaPerdidasYGananciasBalanceAnual()
        {

        }

        public ComparativaPerdidasYGananciasBalanceAnual(IContextService context) : base(context)
        {
        ...
        internal override string GenerarFiltrosColumnas()
        {
            ...
            if (!Lineassinsaldo)
            {
                ...
                else
                {
                    ...
                    sb.Append(" saldo <> 0 or saldoea <> 0 ");
                }
        ...
        internal override string GenerarSelect()
        {
            ...
            if (Desglosarniveltres)
            {
                sb.Append("SELECT cab.actpas as [Activo/Pasivo], cab.orden as Orden, cab.descrip as [Descripción], lin.cuenta as Cuenta, lin.saldo as Saldo, lin.saldoea as SaldoEA FROM ReportGuiasBalancesBalanceAnual cab, ReportGuiasBalancesLineasBalanceAnual lin");
            }
            else
            {
                sb.Append("Select actpas as [Activo/Pasivo], orden as Orden, textogrupo as [Texto Grupo], descrip as [Descripción], saldo as Saldo, saldoea as SaldoEA from ReportGuiasBalancesBalanceAnual");
            }
