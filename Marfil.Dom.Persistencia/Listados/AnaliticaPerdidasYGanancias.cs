...
{
    public class AnaliticaPerdidasYGanancias : ListadosModel
    {
        #region Properties
        public override string TituloListado => "Analitica Pérdidas y Ganancias";

        public override string IdListado => FListadosModel.AnaliticaPerdidasYGanancias;
        ...
        public AnaliticaPerdidasYGanancias()
        {

        }

        public AnaliticaPerdidasYGanancias(IContextService context) : base(context)
        {
        ...
        internal override string GenerarSelect()
        {
            ...
            if (Desglosarniveltres)
            {
                sb.Append("SELECT cab.orden as Orden, cab.descrip as [Descripción], lin.cuenta as Cuenta, lin.saldo as Saldo FROM ReportAnaliticaGuiasBalances cab, ReportAnaliticaGuiasBalancesLineas lin");
            }
            else
            {
                sb.Append("Select orden as Orden, textogrupo as [Texto Grupo], descrip as [Descripción], saldo as Saldo from ReportAnaliticaGuiasBalances");
            }        
