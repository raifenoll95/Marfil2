...
{
    public class ListadoCuentasNoAsignadasAnalitica : ListadosModel
    {
        ...
        internal override string GenerarSelect()
        {
            ...
            sb.Append("select asi.fkcuentas as Cuenta, c.descripcion as [Descripción], asi.debe as Debe, asi.haber as Haber, asi.saldo as Saldo from CuentasNoAsignadasAnalitica as asi, Cuentas as c");
        ...
        public ListadoCuentasNoAsignadasAnalitica()
        {

        }

        public ListadoCuentasNoAsignadasAnalitica(IContextService context) : base(context)
        {
