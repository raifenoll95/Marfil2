...
{
    public class ListadosStockValorado : ListadosModel
    {
        ...
        public override string TituloListado => Menuaplicacion.listadostockvalorado;
        ...
        #region Properties
        public override string WebIdListado => FListadosModel.StockGeneralValorado;
        ...
        public ListadosStockValorado()
        {

        }

        public ListadosStockValorado(IContextService context) : base(context)
        {
