...
using Resources;
using RTransformacioneslotesnave = Marfil.Inf.ResourcesGlobalization.Textos.Entidades.Transformacioneslotesnave;
...
namespace Marfil.Dom.Persistencia.Model.Documentos.Transformacioneslotesnave
{
    public class TransformacioneslotesnaveModel : BaseModel<TransformacioneslotesnaveModel, Persistencia.Transformacioneslotesnave>, IDocument
    {
        private List<TransformacioneslotesnaveLinModel> _lineassalida = new List<TransformacioneslotesnaveLinModel>();
        private List<TransformacioneslotesnaveCostesadicionalesModel> _costes = new List<TransformacioneslotesnaveCostesadicionalesModel>();
        ...
        public List<TransformacioneslotesnaveLinModel> Lineas
        {
            get { return _lineassalida; }
            set { _lineassalida = value; }
        }

        public List<TransformacioneslotesnaveCostesadicionalesModel> Costes
        {
            get { return _costes; }
            set { _costes = value; }
        }
        ...
        public TransformacioneslotesnaveModel()
        {

        }

        public TransformacioneslotesnaveModel(IContextService context) : base(context)
        {
        ...
        public override string DisplayName => RTransformacioneslotesnave.TituloEntidad;
        public DocumentosBotonImprimirModel GetListFormatos()
        {
            ...
            using (var db = MarfilEntities.ConnectToSqlServer(user.BaseDatos))
            {
                ...
                var service = new DocumentosUsuarioService(Context, db);
                {
                    ...
                    {
                        Tipo = TipoDocumentoImpresion.TransformacionesAcabados,
    ...
    public class TransformacioneslotesnaveLinModel : IDocumentosLinModel
    {
    ...
    public class TransformacioneslotesnaveCostesadicionalesModel
    {
        public int Id { get; set; }
    ...
    public class TransformacioneslotesnaveLinVistaModel
    {
    ...
    public partial class TransformacioneslotesnavelinSerialized
    {
        public string empresa { get; set; }
    ...
    public class TransformacioneslotesnaveDiarioStockSerializable
    {
        public int Id { get; set; }
        public string Referencia { get; set; }
        public DateTime? Fechadocumento { get; set; }
        public string Codigoproveedor { get; set; }
        public TransformacioneslotesnavelinSerialized Linea { get; set; }
