...
namespace Marfil.Dom.Persistencia.ServicesView.Servicios.Contabilidad
{
    ...
    public class GuiasBalancesService : GestionService<GuiasBalancesModel, GuiasBalances>, IGuiasBalances
    {
        ...
        public string GetFiltroAcumuladorAnt()
        {
            ...
            if (registro != null)
            {
                return ejercicioant + "-" + _context.Usuario;
            }
            else
            {
                return "";
        ...
        public string TextRecalculoPYGAnalitica(FiltrosAcumulador filtrosAcumulado, bool esejercicioant)
        {
        ...
        public string TextRecalculoPYGBalanceAnual(FiltrosAcumulador filtrosAcumulado, bool esejercicioant)
        {
