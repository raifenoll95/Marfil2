    ...
    public class IncidenciasCRMService : GestionService<IncidenciasCRMModel, IncidenciasCRM>, IIncidenciasCRMService
    {
        ...
        public override void create(IModelView obj)
        {
            using (var tran = TransactionScopeBuilder.CreateTransactionObject())
            {
                ...
                var tipodocumento = "INC"; //Incidencias
                var contador = ServiceHelper.GetNextId<IncidenciasCRM>(_db, Empresa, model.Fkseries, tipodocumento);
                var identificadorsegmento = "";
                model.Referencia = ServiceHelper.GetReference<IncidenciasCRM>(_db, model.Empresa, model.Fkseries, tipodocumento, contador, model.Fechadocumento.Value, out identificadorsegmento);
